...
export const metadata = {
	openGraph: {
		...
		images: [{ url: 'https://nifnip22-portfolio.vercel.app/profile.jpg', width: 800, height: 800 }],
		charset: 'UTF-8',
		locale: 'en-US',
		type: 'website',
		robots: 'index, follow',
		...
		twitterImages: [{ url: 'https://nifnip22-portfolio.vercel.app/profile.jpg', width: 800, height: 800 }],
