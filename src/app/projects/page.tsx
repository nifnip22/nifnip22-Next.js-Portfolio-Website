			...
			<MainLayout>
				<div className='h-4/5 flex flex-col justify-start gap-y-20'>
					...
					<motion.div
						...
						<ProjectCard img='/project_img/project-1.png' title='Portfolio Website Project' url='https://nifnip22-portfolio.vercel.app/' githuburl='https://github.com/nifnip22/nifnip22-Next.js-Portfolio-Website'/>
					</motion.div>
				</div>
			</MainLayout>
		</>
